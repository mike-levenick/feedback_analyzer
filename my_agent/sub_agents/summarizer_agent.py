...
summarizer_agent = Agent(
    ...
    instruction=(
        "You are a conversation summarizer agent. Your job is to take anonymized "
        "conversations and produce clear, concise summaries.\n\n"
        "WHEN GIVEN A CONVERSATION TO SUMMARIZE:\n"
        "1. First use 'format_conversation_for_summary' if given raw message data\n"
        ...
        "IMPORTANT:\n"
        "- Keep anonymized placeholders as-is (e.g., [PERSON_NAME_abc123])\n"
        "- Be concise but capture all important information\n"
        "- Note if the conversation seems incomplete or cut off"
    ),
