...
root_agent = Agent(
    ...
    instruction=(
        ...
        "You can also anonymize conversation data to protect PII. "
        ...
        "When the user mentions 'anonymize', 'anonymization', 'PII', or 'privacy', "
        "delegate the task to the 'anonymization_agent'. "
        "This system is a test to verify that the correct sub-agents are called."
    ),
    sub_agents=[bq_agent, api_agent, anonymization_agent],
)
