...
@click.option(
    "--requirements-file",
    default="feedback_analyzer/app_utils/.requirements.txt",
    help="Path to requirements.txt file",
)
@click.option(
    "--env-file",
    default=None,
    help="Path to .env file for environment variables (defaults to feedback_analyzer/.env)",
)
@click.option(
    "--set-env-vars",
    default=None,
